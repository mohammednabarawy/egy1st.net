...
if (get_post_meta($post->ID, "category", true) != "") {
    $args["tax_query"][] = array("taxonomy" => "category", "terms" => get_post_meta($post->ID, "category", true), "field" => "id", "include_children" => true, "operator" => "IN");
}
if (get_post_meta($post->ID, "ser", true) != "") {
    $args["tax_query"][] = array("taxonomy" => "selary", "terms" => get_post_meta($post->ID, "ser", true), "field" => "id", "include_children" => true, "operator" => "IN");
}
if (get_post_meta($post->ID, "movseries", true) != "") {
    $args["tax_query"][] = array("taxonomy" => "assemblies", "terms" => get_post_meta($post->ID, "movseries", true), "field" => "id", "include_children" => true, "operator" => "IN");
}
if (get_post_meta($post->ID, "genre", true) != "") {
    $args["tax_query"][] = array("taxonomy" => "genre", "terms" => get_post_meta($post->ID, "genre", true), "field" => "id", "include_children" => true, "operator" => "IN");
}
if (get_post_meta($post->ID, "quality", true) != "") {
    $args["tax_query"][] = array("taxonomy" => "Quality", "terms" => get_post_meta($post->ID, "quality", true), "field" => "id", "include_children" => true, "operator" => "IN");
}
if (get_post_meta($post->ID, "language", true) != "") {
    $args["tax_query"][] = array("taxonomy" => "language", "terms" => get_post_meta($post->ID, "language", true), "field" => "id", "include_children" => true, "operator" => "IN");
}
