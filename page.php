...
echo "</a></div>";
echo "<img src=\"" . $poster . "\" alt=\"" . get_the_title($post->ID) . "\" title=\"" . get_the_title($post->ID) . "\">";
echo "<div class=\"MainBottom\"><div class=\"MetaPosted\">";
...
echo "</div></div><div class=\"story Comment IsNewsSingle\">";
